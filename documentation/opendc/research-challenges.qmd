...
description: Open problems in physics and AI/ML research, and the related open challenges.
---
...
### Open Challenge P-I — Panoptic Segmentation on 3D Points {.unnumbered}
...
### Open Challenge P-II — Ring Counting and Particle Identification {.unnumbered}

Water Cherenkov blablabla

### Open Challenge P-III — Cross-detector Transfer {.unnumbered}

[View challenge](../../challenges/cross-detector-transfer/)
...
### Open Challenge P-IV — Generator Surrogate Models {.unnumbered}

### Open Challenge P-V — Detector Surrogate Models {.unnumbered}
...
### Open Challenge M-I — Event Completion {.unnumbered}
