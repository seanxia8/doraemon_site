...
![Neutrino flux and energy spectrum](/docs/physics/images/NuSpectrum.png)
...
![Reins and Cowan detector setup](/docs/physics/images/ReinsCowan.png)
...
![Super-Kamiokande detector and Cherenkov ring examples](/docs/physics/images/SuperK.png)
...
![MicroBooNE LArTPC event display](/docs/physics/images/LArTPC.png)
